          ...
          <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-brand nav-tabs-line-2x nav-tabs-line-right nav-tabs-bold"
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="tab" href="#myprofile_2_tab_content" role="tab">
                <i class="fas fa-flag-checkered" aria-hidden="true"></i>Racer Profile
                <i v-if="profile.is_racer" class="la la-check-circle text-success"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-toggle="tab" href="#myprofile_3_tab_content" role="tab">
                <i class="fas fa-building" aria-hidden="true"></i>Staff Promotor Profile
                <i v-if="profile.is_staff_promotor" class="la la-check-circle text-success"></i>
              </a>
            </li>
            <li class="nav-item">
      ...
      <div class="kt-portlet__body">
        <div class="tab-content">
          ...
          <div class="tab-pane" id="myprofile_2_tab_content" role="tabpanel">
            <form class="kt-form kt-form--label-right" @submit.prevent="saveProfileInfo('racer')">
              <div class="kt-section kt-section--first">
                <div class="kt-section__body">
                  <div class="form-group kt-form__group row">
                    ...
                    <div class="col-md-6">
                      <span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--success">
                        <label>
                          <input type="checkbox" checked="checked" v-model="profile.is_racer">
                          <span></span>
                        </label>
                      </span>
                    </div>
                  ...
                  <div class="form-group kt-form__group row">
                    ...
                    <div class="col-md-6">
                      <div class="input-group date">
                        <vue-datetimepicker v-model="profile.racer.birth_date"
                  ...
                  <div class="form-group kt-form__group row">
                    ...
                    <div class="col-md-6">
                      <input type="text" class="form-control" placeholder="Phone Number" v-model="profile.racer.phone">
                    </div>
                  </div>
                  <div class="form-group kt-form__group row">
                    <label class="col-md-2 col-form-label">Street Address</label>
                    <div class="col-md-6">
                      <input type="text" class="form-control" placeholder="Street Address" v-model="profile.racer.street_address">
                    </div>
                  </div>
                  <div class="form-group kt-form__group row">
                    <label class="col-md-2 col-form-label">Country</label>
                    <div class="col-md-6">
                      <input type="text" class="form-control" placeholder="Country" v-model="profile.racer.country">
                    </div>
                  </div>
                  <div class="form-group kt-form__group row">
                    <label class="col-md-2 col-form-label">City</label>
                    <div class="col-md-6">
                      <input type="text" class="form-control" placeholder="City" v-model="profile.racer.city">
                    </div>
                  </div>
                  <div class="form-group kt-form__group row">
                    <label class="col-md-2 col-form-label">State</label>
                    <div class="col-md-6">
                      <input type="text" class="form-control" placeholder="State" v-model="profile.racer.state">
                    </div>
                  </div>
                  <div class="form-group kt-form__group row">
                    <label class="col-md-2 col-form-label">Zip Code</label>
                    <div class="col-md-6">
                      <input type="text" class="form-control" placeholder="Zip Code" v-model="profile.racer.zipcode">
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="tab-pane" id="myprofile_3_tab_content" role="tabpanel">
            <form class="kt-form kt-form--label-right" @submit.prevent="saveProfileInfo('staff_promotor')">
              <div class="kt-section kt-section--first">
                <div class="kt-section__body">
                  <div class="form-group kt-form__group row">
                    <label class="col-md-2 col-form-label">Enabled?</label>
                    <div class="col-md-6">
                      <span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--success">
                        <label>
                          <input type="checkbox" checked="checked" v-model="profile.is_staff_promotor">
                          <span></span>
                        </label>
                      </span>
                    </div>
  ...
  methods: {
    ...
    getProfilePostData: function(profileType) {
      ...
      if (profileType === "basic") {
        ["first_name", "last_name", "gender", "avatar"].forEach(function (f) {
      ...
      else if (profileType === "racer") {
        postData["racer"] = this.profile.racer || {};
        postData["is_racer"] = this.profile.is_racer === true;
        if (postData.racer.birth_date && typeof postData.racer.birth_date === "object") {
          postData.racer.birth_date = moment(postData.racer.birth_date).format("YYYY-MM-DD");
        }
      }
      else if (profileType === "staff_promotor") {
        postData["staff_promotor"] = this.profile.staff_promotor || {};
        postData["is_staff_promotor"] = this.profile.is_staff_promotor === true;
      }
      return postData;
    },
