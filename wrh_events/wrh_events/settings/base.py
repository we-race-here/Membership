"""
Django settings for wrh_events project.
...
EXTERNAL_CONFIG_PATH = '/opt/webapps/wrh_events/etc/external_config.py'

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/2.1/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = '<WRH_EVENTS_SECRET_KEY>'
...
MIDDLEWARE = [
    ...
    'wrh_events.helpers.middleware.DisableCSRFMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    'wrh_events.helpers.middleware.InjectUiVersionInHeadersMiddleware',
    'wrh_events.helpers.middleware.CustomRevisionMiddleware',
]

REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'wrh_events.helpers.utils.custom_rest_exception_handler',
    'DEFAULT_PERMISSION_CLASSES': [
        'wrh_events.helpers.utils.CustomDjangoModelPermissions'
    ],
    ...
    'DEFAULT_PAGINATION_CLASS': 'wrh_events.helpers.utils.CustomPagination',
    'DEFAULT_FILTER_BACKENDS': ('rest_framework_filters.backends.DjangoFilterBackend',
                                'rest_framework.filters.SearchFilter',
                                'wrh_events.helpers.utils.ExtendedOrderingFilterBackend'),
...
ROOT_URLCONF = 'wrh_events.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'wrh_events', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
            ...
            'libraries': {
                'util_tags': 'wrh_events.templatetags.util_tags',
            }
        },
    },
]

WSGI_APPLICATION = 'wrh_events.wsgi.application'
