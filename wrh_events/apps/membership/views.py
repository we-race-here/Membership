...
from wrh_events.helpers.shortcuts import unsign
from wrh_events.helpers.utils import PermissionRequiredMixin, success_message, send_form_errors, ex_reverse, \
    error_message
...
class SignUpView(View):
    ...
    def _send_activation_email(self, email):
        ...
        subject = 'WRH-Events Registration'
...
class ForgotPasswordView(View):
    ...
    def _send_recovery_email(self, email):
        ...
        subject = 'WRH-Events Recovery Password'
        from_email = settings.DEFAULT_EMAIL_FROM
        return send_mail(subject, message, from_email, [email], html_message=message, fail_silently=False)
